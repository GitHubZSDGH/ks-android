...
public class RoundedImageView extends ImageView {
    ...
    public RoundedImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        borderWidth = a.getDimensionPixelSize(R.styleable.RoundedImageView_biankuang_width, -1);
        ...
        borderColor = a.getColorStateList(R.styleable.RoundedImageView_biankuang_color);
        if (borderColor == null) {
