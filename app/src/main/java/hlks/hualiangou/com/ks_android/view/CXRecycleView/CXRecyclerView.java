package hlks.hualiangou.com.ks_android.view.CXRecycleView;
...
//        }
    ...
    public void setPullRefreshEnabled(boolean enabled) {//设置是否可以刷新
        Log.e("head", "setPullRefreshEnabled");
