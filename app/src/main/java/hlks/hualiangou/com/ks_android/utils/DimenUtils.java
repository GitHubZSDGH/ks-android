...
public class DimenUtils {
    ...
    public static float dpToPx(float dp) {
        return dp * App.mContext.getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToDp(float px) {
        return px / App.mContext.getResources().getDisplayMetrics().density;
    }
    ...
    public static float pxToSp(float pxValue) {
        return pxValue / App.mContext.getResources().getDisplayMetrics().scaledDensity;
    }
    ...
    public static float spToPx(float spValue) {
        return spValue * App.mContext.getResources().getDisplayMetrics().scaledDensity;
    }
}
