...
public class HomeMiaoShaAdapter extends BaseRecyclerAdapter<HomefragmentBean.MsgBean.SpikeBean.SpikeShopBean> {
    ...
    public HomeMiaoShaAdapter(Collection<HomefragmentBean.MsgBean.SpikeBean.SpikeShopBean> collection, @LayoutRes int layoutId, AdapterView.OnItemClickListener listener) {
