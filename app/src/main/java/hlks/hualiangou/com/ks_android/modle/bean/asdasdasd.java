...
public class asdasdasd {
    ...
    public static class MsgBean implements Parcelable {
        ...
        public static class ShopFeaturesBean {
            /**
        ...
        public void writeToParcel(Parcel dest, int flags) {
            ...
            dest.writeList(this.shop_image);
            dest.writeList(this.shop_features);
            dest.writeList(this.shop_spec);
        }
        ...
        protected MsgBean(Parcel in) {
            ...
            this.shop_image = new ArrayList<ShopImageBean>();
            in.readList(this.shop_image, ShopImageBean.class.getClassLoader());
            this.shop_features = new ArrayList<ShopFeaturesBean>();
            in.readList(this.shop_features, ShopFeaturesBean.class.getClassLoader());
            this.shop_spec = new ArrayList<ShopSpecBean>();
            in.readList(this.shop_spec, ShopSpecBean.class.getClassLoader());
        }
